  ...
  return (
    <main className="bg-white flex flex-col items-center w-full reveal">
      ...
      <section className="w-full max-w-[1440px] px-4 py-8 flex flex-col">
        <h1 className="reveal text-center text-2xl font-medium text-[#111111]">
          GET HELP
        </h1>
        <div className="mt-8 flex justify-center ">
          <div className= "lg:w-[457px] w-full rounded-lg border  sm:ml-5 text-gray-500/80 py-3 border-slate-800/60 " >
          <p className="ml-2">
        ...
        <div className="mt-16 flex flex-col lg:flex-row gap-8 reveal">
          <article className="flex-1">
            <h2 className="text-xl ml-4 font-semibold  text-[#111111]">
              WHAT PAYMENT OPTIONS CAN I USE ON NIKE ORDERS?
            </h2>
            <p className="ml-5 mt-8 text-sm text-[#111111]">
            ...
            <ul className="mt-4 ml-5 list-none pl-5 text-sm text-[#111111]">
              <li>Visa, Mastercard, Diners Club, Discover, American Express</li>
              <li>Visa Electron, Maestro</li>
              <li>Apple Pay</li>
            </ul>
            <p className="mt-8 ml-5 text-sm text-[#111111]">
            ...
            <div className="ml-2 mt-11 reveal">
              <h1 className="font-semibold">Faq&apos;s</h1>
            <h1 className="text-slate-900 font-semibold mt-10">Does my card need international purchases enabled?</h1>
          ...
          <aside className="reveal w-full  lg:w-[300px] text-center border h-[650px] border-r-0 border-t-0 border-b-0">
