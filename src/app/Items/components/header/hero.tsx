  ...
  return (
    <div className="w-full p-2 overflow-x-hidden">
      ...
      <div className="reveal flex justify-center items-center text-center flex-col p-10">
                ...
                <p  className="text-sm leading-5 w-[100%] pt-3 pb-2 text-center mt-5">
                Extreme comfort. Hyper durable. Max volume. Introducing the Air Max Pulse
                —designed to push you past your limits and help you go to the max.
           
                </p>
                <div className="flex justify-center text-black items-center mt-7 gap-3 hover:opacity-85"><button>Notify Me</button>
